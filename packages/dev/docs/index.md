...
<CardGroup cols={2}>
  <Card title="@djs-core/runtime" icon="npm" href="https://npmjs.com/package/@djs-core/runtime">
    The core runtime library for your bot.
  </Card>
  <Card title="@djs-core/dev" icon="npm" href="https://npmjs.com/package/@djs-core/dev">
    Development tools and CLI for djs-core.
  </Card>
  <Card title="@djs-core/db" icon="npm" href="../essentials/database.md">
    Native Drizzle database — client.db and djs-core db CLI.
  </Card>
</CardGroup>
...
- **Native Database**: Drizzle built in — `db:` config, `client.db`, and `djs-core db` CLI.
- **Plugin System**: Third-party plugins via `definePlugin`; official DB plugins deprecated.

## Next Steps

Ready to build your bot?

<Card title="Get started" icon="rocket" href="/getting-started/installation" horizontal>
