...
import g from "./src/interactions/commands/utils/handler/button.ts.old";
import h from "./src/interactions/commands/utils/handler/modal.ts.old";
import i from "./src/interactions/commands/utils/handler/select.ts.old";
