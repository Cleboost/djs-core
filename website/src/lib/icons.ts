export const ICONS: Record<string, string> = {
	house: `<path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1Z"/>`,
	download: `<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/>`,
	"folder-tree": `<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/><path d="M12 10v6"/><path d="m15 13-3 3-3-3"/>`,
	message: `<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>`,
	terminal: `<polyline points="4 17 10 11 4 5"/><line x1="12" x2="20" y1="19" y2="19"/>`,
	"mouse-pointer": `<path d="m4 4 7.07 17 2.51-7.39L21 11.43z"/>`,
	"clock-eleven-thirty": `<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16.2 14.2"/>`,
	...
	"window-maximize": `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/>`,
	...
	"box-open": `<path d="M12 22v-9"/><path d="M3.17 9.17 12 13l8.83-3.83"/><path d="M21 16V8a2 2 0 0 0-1.11-1.79l-7-3.5a2 2 0 0 0-1.78 0l-7 3.5A2 2 0 0 0 3 8v8a2 2 0 0 0 1.11 1.79l7 3.5a2 2 0 0 0 1.78 0l7-3.5A2 2 0 0 0 21 16Z"/>`,
	...
	"arrow-pointer": `<path d="m4 4 7.07 17 2.51-7.39L21 11.43z"/>`,
	asterisk: `<path d="M12 6v12"/><path d="M6 12h12"/><path d="m8 8 8 8"/><path d="m16 8-8 8"/>`,
	water: `<path d="M12 2.69 17.66 8A8 8 0 1 1 6.34 8Z"/>`,
	npm: `<rect width="20" height="20" x="2" y="2" rx="2"/><path d="M7 7h3v10H7z"/><path d="M10 7h3v3h-3z"/>`,
	database: `<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 18 0V5"/><path d="M3 12a9 3 0 0 0 18 0"/>`,
	sparkles: `<path d="m12 3-1.9 5.8L4.3 10.7l5.8 1.9L12 18.5l1.9-5.9 5.8-1.9-5.8-1.9Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/>`,
